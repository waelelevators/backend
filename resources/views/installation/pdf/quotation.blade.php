...
@section('content')
    @php
        ...
        $contractText = str_replace('PEOPLE_LOAD', $data['PEOPLE_LOAD'], $contractText);
        $contractText = str_replace('MACHINE_LOAD', $data['MACHINE_LOAD'], $contractText);
        $contractText = str_replace('ELEVATOR_TYPE', $data['ELEVATOR_TYPE'], $contractText);
        $contractText = str_replace('MACHINE_WARRANTY', $data['MACHINE_WARRANTY'], $contractText);
        ...
        $contractText = str_replace('TABLE', $data['TABLE'], $contractText); // المواصفات الفنية
